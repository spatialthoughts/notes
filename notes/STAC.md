...
- [S2 Median Composite of Ireland with Coiled](https://github.com/ahwallace/semantic-eo/blob/main/src/semanticeo/s2_processing.py): Python script for creating Sentinel-2 median composites using Coiled (Dask cloud) and STAC. Related: [[Remote_Sensing]], [[XArray]], [[CNG]]. Keywords: STAC, Sentinel-2, composite, Dask, Coiled, cloud-native, Python

- [odc-stac vs stackstac comparison](https://discourse.pangeo.io/t/comparing-odc-stac-load-and-stackstac-for-raster-composite-workflow/4097/33): Pangeo forum discussion comparing odc-stac and stackstac for raster composite workflows. Related: [[XArray]], [[Python]]. Keywords: STAC, odc-stac, stackstac, Pangeo, Python, comparison
...
- [Bitmasking Sentinel-2 with STAC](https://discourse.pangeo.io/t/comparing-odc-stac-load-and-stackstac-for-raster-composite-workflow/4097/14): Pangeo forum discussion on Sentinel-2 bitmask handling in STAC-based raster workflows. Related: [[Remote_Sensing]], [[XArray]], [[Python]]. Keywords: STAC, Sentinel-2, bitmasking, Pangeo, Python

## Earlier

- [PySTAC QuickStart](https://pystac.readthedocs.io/en/latest/quickstart.html): Official quickstart guide for PySTAC Python library for working with STAC catalogs. Related: [[Python]], [[Remote_Sensing]]. Keywords: STAC, PySTAC, Python, catalog, satellite data
