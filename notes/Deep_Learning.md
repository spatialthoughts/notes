...
- [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning): Comprehensive resource list for performing deep learning on satellite imagery. Related: [[Remote_Sensing]]. Keywords: deep learning, satellite imagery, resources, remote sensing

- [Crop Classification CNN Fastai](https://github.com/simongrest/farm-pin-crop-detection-challenge): Crop classification using convolutional neural networks with Fastai framework. Related: [[Agriculture]]. Keywords: deep learning, crop classification, CNN, Fastai, agriculture

- [Development Seed TensorFlow EO Tutorial](https://developmentseed.org/tensorflow-eo-training/docs/index.html): Development Seed tutorial series on using TensorFlow for Earth observation tasks. Related: [[Remote_Sensing]], [[Python]]. Keywords: deep learning, TensorFlow, Earth observation, remote sensing, Python
...
- [DeepWater](https://github.com/isikdogan/deepwatermap): Deep learning model for global surface water mapping from satellite imagery. Related: [[Remote_Sensing]]. Keywords: deep learning, water mapping, global, satellite imagery
