...
- [MapToPoster](https://github.com/originalankur/maptoposter): Python tool that generates beautiful minimalist map posters for any city from OpenStreetMap data with customizable themes and high-resolution export. [Keywords: `OSM` `cartography` `poster` `city maps` `Python`]

## 2025

- [Guide to Claude Code](https://sankalp.bearblog.dev/my-experience-with-claude-code-20-and-how-to-get-better-at-using-coding-agents/): Blog post on experience with Claude Code 2.0 and how to use AI coding agents effectively. [Keywords: `AI` `coding agents` `Claude` `productivity`]
...
- [Image Generator - Visual Electric](https://visualelectric.com/): AI-powered image generation tool with a design-focused interface. [Keywords: `AI` `image generation` `creative` `design`]

- [GeoBoundaries API](https://www.geoboundaries.org/api/current/gbOpen/IND/ADM1/): Open administrative boundary API providing GeoJSON data for any country/region. [Keywords: `data` `administrative boundaries` `API` `GIS`]

## Earlier

- [OOKLA Open Data](https://github.com/teamookla/ookla-open-data): Open dataset of global broadband speed test data from Ookla for mobile and fixed internet. [Keywords: `data` `broadband` `internet speed` `Ookla` `open data`]
...
- [UK Police Crime Data](https://data.police.uk/data/): Open crime data for the United Kingdom with metadata documentation. [Keywords: `data` `crime` `UK` `police` `open data`]
...
- [Felt Maps - Collaborative Map Making](https://felt.com/): Collaborative online map making platform for teams. [Keywords: `web mapping` `collaboration` `maps` `GIS` `SaaS`]

- [Denmark AIS Data](http://web.ais.dk/aisdata/): Free Automatic Identification System (AIS) ship tracking data for Denmark. [Keywords: `AIS` `ships` `maritime` `Denmark` `open data`]

- [GeoDataFlow Pipeline Tool](https://github.com/ahuarte47/geodataflow): Pipeline tool for geospatial data processing similar to GDAL/OGR workflows. [Keywords: `GIS` `data pipeline` `GDAL` `geospatial` `Python`]
